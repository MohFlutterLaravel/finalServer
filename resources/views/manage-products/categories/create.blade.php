            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">NewCategorie</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    @endsection
                    @endif
                    <h3 class="card-title">Create a new categorie</h3>
                            ...
                            <form role="form" id="quickForm" action="{{ route('categories.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="categorie-name" value="{{ old('categorie-name') }}" class="form-control" id="cat1" placeholder="Enter categorie name ..">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="categorie-image" value="{{ old('categorie-image') }}" class="form-control" id="cat2" placeholder="Enter categorie image ..">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="categorie-color" value="{{ old('categorie-color') }}" class="form-control" id="cat3" placeholder="Enter role name ..">
