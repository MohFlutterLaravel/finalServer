            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">NewProduit</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    @endsection
                    @endif
                    <h3 class="card-title">Create a new Produit</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('produits.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product-name" value="{{ old('product-name') }}" class="form-control" id="ProductName" placeholder="Enter Product name ..">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="product-description" rows="3" id="ProduitDescription" placeholder="Enter Product description ..">{{ old('product-description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="product-pa" value="{{ old('product-pa') }}" class="form-control" id="ProductPA" placeholder="Enter Product PA ..">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="product-pv" value="{{ old('product-pv') }}" class="form-control" id="ProductPV" placeholder="Enter Product PV ..">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="product-re" value="{{ old('product-re') }}" class="form-control" id="ProductRE" placeholder="Enter Product RE ..">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="product-image" value="{{ old('product-image') }}" class="form-control" id="ProductImage" placeholder="Enter Product image ..">
                                    @if($errors->has('product-image'))
                                        <span class="error badge badge-danger">{{ $errors->first('product-image') }}</span>
                                        @endif
                                </div>
                            </div>
                        ...
                        <div class="form-check">
                            <input name="en-stock" type="checkbox" class="form-check-input" value="1" checked>
