    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                  <div class="row route">
                    <div class="col-md-3"  data-toggle="tooltip" title="rejected orders">
                      ...
                      <div class="col-md-3" data-toggle="tooltip" title="valide orders">
                      ...
                      <div class="col-md-3" data-toggle="tooltip" title="shipped orders">
                      ...
                      <div class="col-md-3" data-toggle="tooltip" title="new orders">
                      ...
                      <div class="col-md-6"></div>
                        <div class="col-md-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Orders_Table</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Orders Table with all Orders in the <strong class="text-success">Database</strong> </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
