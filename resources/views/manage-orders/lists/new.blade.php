                      ...
                      <div class="col-md-6"></div>
                        <div class="col-md-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">New_Orders</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Orders Table with all Orders <strong class="text-warning">New</strong> </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
...
$('#orders-table').DataTable({
    processing: true,
    serverSide: true,
    ajax: '{!! route('datatables.orders.new') !!}',
    columns: [
        { data: 'id', name: 'id' },
